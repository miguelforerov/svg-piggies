            ...
            {collections.map((collection) => (
              <li key={collection.id}>
                <button
                  ...
                  className={`flex w-full cursor-pointer items-center justify-between ${
                    selectedCollection === collection.slug
                      ? "font-semibold text-text-dark dark:text-darkmode-text-dark"
                ...
                >
                  ...
                  <span className="flex h-4 w-4 items-center justify-center rounded-sm border border-border dark:border-border/40">
